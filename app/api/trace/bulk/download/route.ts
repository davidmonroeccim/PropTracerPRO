...
import type { TraceJob, TraceHistory, TraceResult } from '@/types';
...
export async function GET(request: Request) {
  try {
    ...
    const csvLines = [
      'address,city,state,zip,owner_name,status,phone_1,phone_2,phone_3,email_1,email_2,email_3,mailing_address,mailing_city,mailing_state,charge',
    ];
