...
export async function POST(request: Request) {
  try {
    ...
    if (fullPropertyTrace) {
      ...
      // unless a person asked it to. The customer sees this result on screen
      // with a Push to CRM button beside it, and that button is the only thing
      // that starts a push: app/api/integrations/highlevel/push.
